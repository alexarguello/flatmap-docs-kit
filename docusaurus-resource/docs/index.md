...
class root col0;
classDef custom0 fill:lightgrey,stroke:green,stroke-width:2px,stroke-dasharray:0;
class _template_md custom0;
classDef custom1 fill:#d5b3ff;
class full_sitemap_md custom1;
classDef custom2 fill:#ffcccc,stroke:green,stroke-width:2px,stroke-dasharray:0;
class n_00_getting_started_what_is_ai_md custom2;
classDef custom3 fill:#ffcccc;
class tutorial_extras_manage_docs_versions_md custom3;
classDef custom4 fill:#ffcccc;
class tutorial_extras_translate_your_site_md custom4;
