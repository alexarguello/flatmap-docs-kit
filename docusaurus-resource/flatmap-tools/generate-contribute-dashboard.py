...
from generate_collaborate_pages import walk_docs as generate_collaborate_pages

def main():
    print("Generating all contribute pages...")
    generate_contribute_pages()
    print("Generating all collaboration pages...")
    generate_collaborate_pages()
